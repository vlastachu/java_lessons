...
По традиции первое занятие каким-либо языком программирования завершается созданием первой программы, которая приветствует этот мир. Выравние не обязательно но так лучше читается.
