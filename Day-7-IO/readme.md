...
Возьмём к примеру задание к 3му дню (например работа Елисеева Дмитрия), после компиляции имеем файлы Main.class и Shape.class (и ещё пара сгенированна). В серьёзных проектов классов будет побольше и иерархия будет тоже пошире. Можно будет пользователю составить скриптик, запускающий нужный класс, а можно сделать один jar-ник. 
...
Примерно так. Но это не работает, надеюсь в ближайшее время разбирусь, что не так...
